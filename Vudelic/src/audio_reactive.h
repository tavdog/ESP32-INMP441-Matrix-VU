...
double fftResultPink[16] = {1,1,1,1,1,1.5,1.5,2,3,4,6,9,10,15,20,40};
...
void FFTcode( void * parameter) {
  ...
  for(;;) {
    ...
    for(int i=0; i<samples; i++) {
       ...
       i2s_read(I2S_PORT, &digitalSample, /*sizeof( digitalSample* )*/ 4, &bytes_read, /*portMAX_DELAY*/ 10); // no timeout
